...
**Step 2: Prove** — Backward slicing isolates the relevant code. SA-Fuzz explores execution paths. A proof-of-failure certificate is generated with formal guarantees.
